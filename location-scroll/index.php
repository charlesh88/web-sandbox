...
<head>
	...
	<script src="static/js/vfn.js"></script>
	<script src="static/js/vfn.browser.js"></script>
	<script src="static/js/vfn.mobile.js"></script>
	<script src="static/js/vfn.app.zone.navigation.js"></script>
    ...
    $(document).ready(function() {  
      VFN.app.zone.navigation.init({});
    });
  </script>
</head>
<body>
  <h1>Location scroll test</h1>
</body>
</html>